...
static void LCD_GPIOInit(void){
    ...
    GPIO_PORTD_AFSEL_R = 0x0;                  // disable alternate functions
    ...
    GPIO_PORTK_AFSEL_R = 0x0;                   // disable alternate functions
    ...
    GPIO_PORTM_AFSEL_R = 0x0;                   // disable alternate functions
    ...
    GPIO_PORTN_AFSEL_R = 0x0;                          // disable alternate functions
    ...
    GPIO_PORTP_AFSEL_R = 0x0;                        // disable alternate functions
    ...
    GPIO_PORTQ_AFSEL_R = 0x0;                      // disable alternate functions
