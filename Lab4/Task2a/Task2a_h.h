 ...
 * 1937153 & 2068579
 * 11/2/2022
 * Header Fle for Lab 2 Task 2c
 */ 


#ifndef Task2a_h.h  // header guards 
#define Task2a_h.h

#define RCGCTIMER (*((volatile uint32_t *)0x400FE604)) //Enables Timers


//Timer 0 Set up Configurations
...
//Methods used in main for compiler use.
...
//Configuration for LEDs and Switches Ports
...
#define NVIC_EN0 (*((volatile uint32_t *)0xE000E100))  //NVIC EN0 interrupt offset = 0x100, Base = 0xE000E000, For Port F and G and Timers
